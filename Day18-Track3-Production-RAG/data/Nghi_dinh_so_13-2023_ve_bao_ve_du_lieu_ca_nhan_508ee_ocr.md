...
Trong Nghị định này, các từ ngữ dưới đây dược hiểu như sau:
...
- c) Giới tính;
- d) Nơi sinh, nơi đăng ký khai sinh, nơi thường trú, nơi tạm trú, nơi ở hiện tại, địa chỉ liên hệ;
- e) Quốc tịch;
...
- k) Thông tin khác gắn liền với một con người cụ thể hoặc giúp xác định một con người cụ thể không thuộc quy định tại khoản 4 Điều này.
...
- b) Tình trạng sức khỏe và đời tư được ghi trong hồ sơ bệnh án, bao gồm thông tin về nhóm máu;
...
nguồngốc tộc, nguồn gốc dân tộc;

c) Thông tin liên quan đến chủng truyền

d) Thông tin về đặc điểm di dượcthừahưởng hoặc có được của cá nhân;

Thông tin về thuộc tính vật lý, đặc điểm sinh học của cá nhân;
...
6. Chủ thể dữ liệu là cá nhân phản ánh dữ liệu cá nhân.

7. Xử lý dữ liệu cá nhân là một hoặc nhiều hoạt động tác động tới dữ liệu cá nhân, như: thu thập; ghi, phân tích, xác nhận; lưu trữ, chỉnh sửa, công khai, truy cập; truy xuất, thu hồi, mã hóa, giải mã, sao chép; chia sẻ, truyền đưa, cung cấp; chuyển giao; xóa, hủy dữ liệu cá nhân hoặc các hành động khác có liên quan.

8. Đồng ý của chủ thể dữ liệu là việc thể hiện rõ ràng, tự nguyện, định việc cho phép xử lý dữ liệu cá nhân của chủ thể dữ liệu.

9. Bên Kiểm soát dữ liệu cá nhân là tổ chức, cá nhân quyết định mục đích và phương tiện xử lý dữ liệu cá nhân.

10. Bên Xử lý dữ liệu cá nhân là tổ chức, cá nhân thực hiện việc xử lý dữ liệu thông qua một hợp đồng hoặc thỏa thuận với Bên Kiểm soát dữ liệu.

11. Bên Kiểm soát và xử lý dữ liệu cá nhân là tổ chức, cá nhân quyết định mục đích, phương tiện và trực tiếp xử lý dữ liệu cá nhân.
...
Xử lý dữ liệu cá nhân tự động là hình thức xử lý dữ liệu cá nhân bằng phương tiện điện tử nhằm đánh giá, phân tích; dự đoán hoạt động của một con người cụ thể, như: thói quen, sở thích, mức độ tin cậy, hành vi; địa điểm, xu hướng; năng lực và các trường hợp khác.

# 14

Chuyển dữ liệu cá nhân ra nước ngoài là hoạt động sử dụng mạng, thiết bị, phương tiện điện tử hoặc các hình thức khác chuyển dữ liệu cá nhân của công dân Việt Nam tới một địa điểm nằm ngoài lãnh thổ của nước Cộng hòa xã hội chủ nghĩa Việt Nam hoặc sử dụng một địa điểm nằm ngoài lãnh thổ của nước Cộng hòa xã hội chủ nghĩa Việt Nam để xử lý dữ liệu cá nhân của công dân Việt Nam; bao gồm:

- a) Tổ chức, doanh nghiệp; cá nhân chuyển dữ liệu cá nhân của công dân Việt Nam cho tổ chức, doanh nghiệp; bộ phận quản lý ở nước ngoài để xử lý đồng ý với mục đích đã được chủ thể dữ liệu hợp pháp.
- b) Xử lý dữ liệu cá nhân của công dân Việt Nam bằng hệ thống tự động nằm ngoài lãnh thổ của nước Cộng hòa xã hội chủ nghĩa Việt Nam của Bên Kiểm soát dữ liệu cá nhân; Bên Kiểm soát và xử lý dữ liệu cá nhân; Bên được chủ thể dữ liệu đồng ý xử lý dữ liệu cá nhân phù hợp với mục đích đã được chủ thể dữ liệu đồng ý.
...
3. Dữ liệu cá nhân chỉ được xử lý với mục đích đã được Bên Kiểm soát dữ liệu cá nhân; Bên Xử lý dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân, Bên thứ ba ký, tuyên bố về xử lý dữ liệu cá nhân.
...
áp dụng các biện pháp bảo vệ, bảo mật trong quá trình xử lý, bao gồm cả việc bảo vệ trước các hành vi vi phạm quy định về bảo vệ dữ liệu cá nhân và phòng chống sự mất mát, phá hủy hoặc thiệt hại do sự cố, sử dụng các biện pháp kỹ thuật.

# 7. Dữ liệu cá nhân chỉ được

mục đích xử lý dữ liệu, trừ trường hợp pháp luật có quy định khác.

# 8. Bên Kiểm soát dữ liệu

Bên Kiểm soát và xử lý dữ liệu cá nhân phải chịu trách nhiệm tuân thủ các nguyên tắc xử lý dữ liệu được quy định từ khoản 1 tới khoản 7 Điều này và chứng minh sự tuân thủ của mình với các nguyên tắc xử lý dữ liệu đó.
...
Chính phủ thống nhất quản lý nhà nước về bảo vệ dữ liệu cá nhân gồm:
...
4. Tuyên truyền; giáo dục pháp luật về bảo vệ dữ liệu cá nhân; truyền thông; biến kiến thức, kỹ năng bảo vệ dữ liệu cá nhân.
...
2. Tham gia tương trợ tư pháp về bảo vệ dữ liệu cá nhân của các quốc gia khác, bao gồm báo; đề nghị khiếu nại, trợ giúp điều tra và trao đổi thông tin, với các biện pháp bảo vệ thích hợp để bảo vệ dữ liệu cá nhân.
...
Chủ thể dữ liệu được ý hoặc không ý cho phép xử lý dữ liệu cá nhân của mình, trừ quy định tại Điều 17 Nghị định này.
3. Quyền truy cập
...
Chủ thể dữ liệu được quyền rút lại sự ý của mình, trừ trường hợp luật có quy định khác.
5. Quyền xóa dữ liệu
...
a) Chủ thể dữ liệu phản đối Bên Kiểm soát dữ liệu cá nhân; Bên được Kiểm soát và xử lý dữ liệu cá nhân xử lý dữ liệu cá nhân của mình nhằm ngăn chặn hoặc hạn chế tiết lộ dữ liệu cá nhân hoặc sử dụng cho mục đích quảng cáo, tiếp thị, trừ trường hợp luật có quy định khác;
...
3. Cung cấp đầy đủ, chính xác dữ liệu cá nhân khi ý cho phép xử lý dữ liệu cá nhân.
4. Tham gia tuyên truyền; biến kỹ năng bảo vệ dữ liệu cá nhân.
5. Thực hiện quy định của pháp luật về bảo vệ dữ liệu cá nhân và tham gia chống các hành vi vi phạm quy định về bảo vệ dữ liệu cá nhân.
...
3. Sự đồng ý của chủ thể dữ liệu phải được thể hiện rõ ràng; bằng văn bản, giọng nói, đánh dấu vào ô đồng ý, cú pháp đồng ý qua tin nhắn; chọn các thiết lập kỹ thuật hoặc qua một hành động khác thể hiện được điều này.
...
5. Sự đồng ý của chủ thể dữ liệu phải được thể hiện ở một định dạng có thể được in, sao chép văn bản, bao gồm cả dưới dạng điện tử hoặc định dạng chứng nhận được.

6. Sự im lặng hoặc phản hồi của chủ thể dữ liệu không được coi là đồng ý một phần hoặc với điều kiện kèm theo.

7. Chủ thể dữ liệu có thể thông báo rằng đồng ý.

8. Đối với xử lý dữ liệu cá nhân nhạy cảm; chủ thể dữ liệu phải được báo rằng dữ liệu cần xử lý là dữ liệu cá nhân nhạy cảm.

9. Sự đồng ý của chủ thể dữ liệu có hiệu lực cho tới khi chủ thể dữ liệu có quyết định khác hoặc khi cơ quan nhà nước có thẩm quyền yêu cầu văn bản.
...
# 11. Thông qua việc ủy quyền theo quy định của Bộ luật Dân sự
...
# Điều 12. Rút lại sự đồng ý không ảnh hưởng đến tính hợp pháp
...
2. Việc rút lại sự đồng ý phải được thể hiện ở một định dạng có thể được in, bao gồm cả dưới dạng điện tử hoặc định dạng chứng minh được.
3. Khi nhận yêu cầu rút lại sự đồng ý của chủ thể dữ liệu, Bên Kiểm soát dữ liệu phải thông báo cho chủ thể dữ liệu cá nhân; Bên Kiểm soát và xử lý dữ liệu cá nhân về hậu quả, thiệt hại có thể xảy ra khi rút lại sự đồng ý.
...
3. Việc thông báo cho chủ thể dữ liệu phải được thể hiện ở một định dạng có thể được in; bao gồm cả dưới dạng điện tử hoặc định dạng kiểm chứng được.



---

# 4. Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân

Điều này trong các trường hợp sau:

- a) Chủ thể dữ liệu đã biết rõ và đồng ý toàn bộ với nội dung quy định tại khoản 1 và khoản 2 Điều này trước khi Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân tiến hành thu thập dữ liệu cá nhân, phù hợp với các quy định tại Điều 9 Nghị định này;
...
1. Chủ thể dữ liệu yêu cầu Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân cung cấp cho bản thân dữ liệu cá nhân của mình.
...
4. Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân cung cấp dữ liệu cá nhân trong trường hợp:
- a) Gây tổn hại tới quốc gia, trật tự an toàn xã hội;
...
Trường hợp tổ chức, cá nhân yêu cầu cung cấp thông tin không biết chữ hoặc bị khuyết tật thể viết yêu cầu thì người tiếp nhận yêu cầu cung cấp thông tin có trách nhiệm giúp điền các nội dung.
...
6. Phiếu yêu cầu cung cấp dữ liệu cá nhân phải bằng tiếng Việt gồm các nội dung chính sau đây:

- Họ, tên; nơi cư trú, địa chỉ; số minh nhân dân, thẻ căn cước công dân hoặc số hộ chiếu của người yêu cầu; số fax, điện thoại, địa chỉ thư điện tử yêu cầu cung cấp; trong đó chỉ rõ tên văn bản; hồ sơ, tài liệu;
- Dữ liệu cá nhân được yêu cầu;
...
- Bên Kiểm soát dữ liệu cá nhân; Bên Kiểm soát và xử lý dữ liệu cá nhân có trách nhiệm tiếp nhận yêu cầu cung cấp dữ liệu cá nhân và theo dõi quá trình;
- Trường hợp dữ liệu cá nhân được yêu cầu không thuộc thẩm quyền thì Bên Kiểm soát dữ liệu cá nhân; Bên Kiểm soát và xử lý dữ liệu cá nhân nhận yêu cầu phải thông báo và hướng dẫn tổ chức, cá nhân yêu cầu đến cơ quan có thẩm quyền hoặc thông báo rõ ràng việc không thể cung cấp dữ liệu cá nhân.
...
1. Chủ thể dữ liệu:
- a) Được truy cập để xem, chỉnh sửa dữ liệu cá nhân của mình sau khi đã được Bên Kiểm soát dữ liệu cá nhân; Bên Kiểm soát và xử lý dữ liệu cá nhân đồng ý, trừ trường hợp luật có quy định khác;
...
2. Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân chỉnh sửa dữ liệu cá nhân của chủ thể dữ liệu sau khi được chủ thể dữ liệu đồng ý ngay khi có thể hoặc theo quy định của pháp luật chuyên ngành; không thông báo tới chủ thể dữ liệu sau 72 giờ kể khi nhận được yêu cầu chỉnh sửa dữ liệu cá nhân của chủ thể dữ liệu.
3. Bên Xử lý dữ liệu cá nhân, Bên thứ ba được chỉnh sửa dữ liệu cá nhân của chủ thể dữ liệu sau khi được Bên Kiểm soát dữ liệu cá nhân; Bên Kiểm soát và xử lý dữ liệu cá nhân đồng ý bằng văn bản và biết rõ đã có sự đồng ý của chủ thể dữ liệu.

# Điều 16. Lưu trữ, xóa, hủy dữ liệu cá nhân

1. Chủ thể dữ liệu yêu cầu Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân xóa dữ liệu cá nhân của mình trong các hợp sau:
...
a) Pháp luật quy định cho phép xóa dữ liệu;

b) Dữ liệu cá nhân được xử lý bởi cơ quan nhà nước có thẩm quyền với mục đích phục vụ hoạt động của cơ quan nhà nước theo quy định của pháp luật;

c) Dữ liệu cá nhân đã công khai theo quy định của pháp luật;

d) Dữ liệu cá nhân được xử lý nhằm phục vụ yêu cầu pháp lý, nghiên cứu khoa học, kê theo quy định của pháp luật;
...
7. Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân, Bên Xử lý dữ liệu cá nhân, Bên thứ ba không thể khôi phục trong trường hợp:
...
# Điều 17. Xử lý dữ liệu cá nhân trong trường hợp cần sự ý của chủ thể dữ liệu
...
3. Việc xử lý dữ liệu của cơ quan nhà nước có thẩm quyền trong trường hợp tình trạng khẩn cấp về an ninh quốc gia, trật tự an toàn xã hội, thảm họa lớn; dịch bệnh nguy hiểm; khi có nguy cơ đe dọa an ninh, quốc phòng nhưng chưa đến mức ban bố tình trạng khẩn cấp; phòng, chống bạo loạn; khủng bố, phòng, chống tội phạm và vi phạm pháp luật theo quy định của luật.
...
# Điều 18. Xử lý dữ liệu cá nhân thu được từ hoạt động ghi âm, ghi hình

Cơ quan; tổ chức có thẩm quyền ghi âm, ghi hình và xử lý dữ liệu cá nhân thu được từ hoạt động ghi âm, ghi hình tại nơi công cộng với mục đích bảo vệ an ninh quốc gia, trật tự an toàn xã hội, và lợi ích hợp pháp của tổ chức, cá nhân theo quy định của pháp luật mà không cần có sự đồng ý của chủ thể. Khi thực hiện việc ghi âm; ghi hình, cơ quan; tổ chức có thẩm quyền có trách nhiệm thông báo để chủ thể hiểu mình đang bị ghi âm, ghi hình, trừ trường hợp pháp luật có quy định khác.

# Điều 19. Xử lý dữ liệu cá nhân của người bị tuyên bố mất tích, đã chết

1. Việc xử lý dữ liệu cá nhân liên quan đến dữ liệu cá nhân của người bị tuyên bố mất tích, đã chết phải được sự đồng ý của vợ; chồng hoặc con thành niên của người đó, trường hợp không có những người này thì phải được...
...
2. Việc xử lý dữ liệu cá nhân của trẻ em có sự đồng ý của trẻ em trong trường hợp trẻ em từ đủ 7 tuổi trở lên và có sự đồng ý của cha, mẹ hoặc người giám hộ theo quy định, trừ trường hợp quy định tại Điều 17 Nghị định này. Bên Kiểm soát dữ liệu cá nhân, Bên Xử lý dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân, Bên thứ ba phải xác minh tuổi của trẻ em trước khi xử lý dữ liệu cá nhân của trẻ em.
3. Ngừng xử lý dữ liệu cá nhân của trẻ em, xóa không thể khôi phục hoặc hủy dữ liệu cá nhân của trẻ em trong trường hợp:
- a) Xử lý dữ liệu không đúng mục đích hoặc đã hoàn thành mục đích xử lý chủ thể dữ liệu đồng ý, trừ trường hợp pháp luật có quy định khác;
...
# 3. Tổ chức, cá nhân kinh doanh dịch vụ tiếp thị, giới thiệu sản phẩm

Quảng cáo có trách nhiệm chứng minh việc sử dụng dữ liệu cá nhân của khách hàng đúng với quy định tại khoản 1 và khoản 2 Điều này.
...
2. Việc thiết lập các hệ phần mềm; biện pháp kỹ thuật hoặc tổ chức các hoạt động thu thập, chuyển giao, mua, bán dữ liệu cá nhân không có sự đồng ý của chủ thể dữ liệu là vi phạm pháp luật.

# Điều 23. Thông báo vi phạm quy định về bảo vệ dữ liệu cá nhân

1. Trường hợp xảy ra vi phạm quy định bảo vệ dữ liệu cá nhân; Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân Công an (Cục An ninh mạng và phòng, chống tội phạm sử dụng công nghệ cao) phải báo cho Bộ thông báo chậm nhất 72 giờ sau khi xảy ra hành vi vi phạm theo Mẫu số 03 tại Phụ lục của Nghị định này. Trường hợp báo sau 72 giờ thì phải kèm theo lý do thông báo chậm, muộn:
...
3. Nội dung báo vi phạm quy định về bảo vệ dữ liệu cá nhân:
...
- d) Mô tả các biện pháp được đưa ra để giảm thiểu tác hại của hành vi vi phạm quy định bảo vệ dữ liệu cá nhân.

Trường hợp không thể thông báo đầy đủ các nội dung quy định tại khoản 3, việc thông báo có thể được thực hiện theo từng đợt; từng giai đoạn.
...
# 5. Bên Kiểm soát dữ liệu cá nhân; Bên Kiểm soát và xử lý dữ liệu cá nhân

phải lập Biên bản xác nhận về việc xảy ra hành vi vi phạm quy định bảo vệ dữ liệu cá nhân; phối hợp với Bộ Công an (Cục An ninh mạng và phòng, chống tội phạm sử dụng công nghệ cao) xử lý hành vi vi phạm.

# 6. Tổ chức, cá nhân thông báo cho Bộ Công an (Cục An ninh mạng và phòng; chống công nghệ cao) khi phát hiện các hợp sau:

- a) Phát hiện hành vi vi phạm pháp luật đối với dữ liệu cá nhân;
- b) Dữ liệu cá nhân bị xử lý sai mục đích, không đúng thỏa thuận ban đầu giữa chủ thể dữ liệu và Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân hoặc vi phạm quy định của pháp luật; không bảo đảm quyền của chủ thể dữ liệu hoặc thực hiện không đúng;
...
i) Đánh giá mức độ ảnh hưởng của việc xử lý dữ liệu cá nhân; hậu quả, thiệt hại không mong muốn có khả năng giảm thiểu hoặc loại bỏ nguy cơ, tác hại đó.

2. Bên Xử lý dữ liệu cá nhân tiến hành lập và lưu giữ Hồ sơ đánh giá tác động xử lý dữ liệu cá nhân trong trường hợp thực hiện hợp tác với Bên Kiểm soát dữ liệu cá nhân. Hồ sơ đánh giá tác động xử lý dữ liệu cá nhân của Bên Xử lý dữ liệu cá nhân, bao gồm:
...
3. Hồ sơ đánh giá tác động xử lý dữ liệu cá nhân quy định tại khoản 1 và văn bản có giá trị pháp lý của Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân hoặc Bên Xử lý dữ liệu cá nhân.
...
xử lý dữ liệu cá nhân, Bên Xử lý dữ liệu cá nhân hoàn thiện Hồ sơ đánh giá tác động xử lý dữ liệu cá nhân trong quy định:

# 6. Bên Kiểm soát dữ liệu cá nhân

Bên Kiểm soát và xử lý dữ liệu cá nhân; Bên Xử lý dữ liệu cá nhân cập nhật; bổ sung Hồ sơ đánh giá tác động gửi Công an (Cục chống tội phạm sử dụng công nghệ cao) theo Mẫu số 05 tại Phụ lục của Nghị định này.
...
2. Hồ sơ đánh giá tác động chuyển dữ liệu và Bên tiếp nhận dữ liệu cá nhân của công dân Việt Nam;

- a) Thông tin và chi tiết liên lạc của Bên chuyển dữ liệu cá nhân của công dân Việt Nam;
- b) Họ tên, chi tiết liên lạc của tổ chức, cá nhân phụ trách của Bên dữ liệu có liên quan tới việc chuyển và tiếp nhận dữ liệu cá nhân của công dân Việt Nam;
...
- e) Đánh giá mức độ ảnh hưởng của việc xử lý dữ liệu cá nhân; hậu quả, không mong muốn có khả năng xảy ra, các biện pháp giảm thiểu hoặc loại bỏ nguy cơ, tác hại đó;
...
3. Hồ sơ đánh giá tác động chuyển dữ liệu cá nhân ra nước ngoài phải có sẵn để phục vụ hoạt động kiểm tra, đánh giá của Bộ Công an.
...
4. Bên chuyển dữ liệu báo gửi Bộ Công an (Cục An ninh mạng và phòng, chống tội phạm sử dụng công nghệ cao) tin về việc chuyển dữ liệu và chi tiết liên lạc của tổ chức, cá nhân phụ trách bằng văn bản sau khi việc chuyển dữ liệu diễn ra thành công.

5. Bộ Công an (Cục An ninh mạng và phòng, chống tội phạm sử dụng công nghệ cao) yêu cầu Bên chuyển dữ liệu ra nước ngoài hoàn thiện Hồ sơ đánh giá tác động chuyển dữ liệu cá nhân ra nước ngoài trong trường hợp hồ sơ chưa đầy đủ và đúng quy định.
...
8. Bộ Công an yêu cầu Bên chuyển dữ liệu ra nước ngoài ngừng chuyển dữ liệu cá nhân ra nước ngoài trong trường hợp:

- a) Khi phát hiện dữ liệu cá nhân được sử dụng vào hoạt động vi phạm lợi ích, an ninh quốc gia của nước Cộng hòa xã hội chủ nghĩa Việt Nam;
...
1. a) Biện pháp quản lý do tổ chức, cá nhân có liên quan tới xử lý dữ liệu cá nhân thực hiện;
2. b) Biện pháp kỹ thuật do tổ chức, cá nhân có liên quan tới xử lý dữ liệu cá nhân thực hiện;
3. c) Biện pháp do cơ quan quản lý nhà nước có thẩm quyền thực hiện theo quy định của Nghị định này và pháp luật có liên quan;
...
4. Kiểm tra an ninh mạng đối với hệ thống và phương tiện, thiết bị phục vụ xử lý dữ liệu cá nhân trước khi xử lý, xoá không thể khôi phục hoặc huỷ các thiết bị chứa dữ liệu cá nhân.

# Điều 28. Bảo vệ dữ liệu cá nhân nhạy cảm

1. Áp dụng các biện pháp quy định tại khoản 2 Điều 26 và Điều 27 Nghị định này.
2. Chỉ định bộ phận có chức năng bảo vệ dữ liệu cá nhân và trao đổi thông tin về bộ phận và cá nhân phụ trách bảo vệ dữ liệu cá nhân với Cơ quan chuyên trách bảo vệ dữ liệu cá nhân. Trường hợp Bên Kiểm soát dữ liệu cá nhân; Bên Kiểm soát và xử lý dữ liệu cá nhân, Bên Xử lý dữ liệu, Bên thứ ba là cá nhân thì trao đổi thông tin của cá nhân thực hiện.
...
# Điều 29. Cơ quan chuyên trách bảo vệ dữ liệu cá nhân và thông tin quốc gia về bảo vệ dữ liệu cá nhân

1. Cơ quan chuyên trách bảo vệ dữ liệu cá nhân là Cục An ninh mạng và phòng chống tội phạm sử dụng công nghệ cao thuộc Bộ Công an, có trách nhiệm giúp Bộ Công an thực hiện quản lý nhà nước về bảo vệ dữ liệu cá nhân.
...
- d) Tiếp nhận thông tin, hồ sơ, dữ liệu về hoạt động bảo vệ dữ liệu cá nhân qua gian mạng;
- e) Cung cấp thông tin về kết quả đánh giá tác bảo vệ dữ liệu cá nhân của cơ quan, tổ chức, cá nhân có liên quan;
- f) Tiếp nhận báo vi phạm quy định về bảo vệ dữ liệu cá nhân;
...
2. Cơ quan, tổ chức, cá nhân có trách nhiệm tuyên truyền; nâng cao nhận thức bảo vệ dữ liệu cá nhân cho cơ quan, tổ chức, cá nhân.
...
1. Nguồn tài chính thực hiện bảo vệ dữ liệu cá nhân bao gồm ngân sách nhà nước; ủng hộ của cơ quan; tổ chức, cá nhân trong và ngoài nước; nguồn thu từ hoạt động cung cấp dịch vụ bảo vệ dữ liệu cá nhân; viện quốc tế và các nguồn thu hợp pháp khác.
2. Kinh phí bảo vệ dữ liệu cá nhân của cơ quan nhà nước do ngân sách hằng năm bảo đảm, được bố trí trong dự toán ngân sách nhà nước. Việc quản lý, sử dụng kinh phí từ ngân sách nhà nước được thực hiện theo quy định của pháp luật về ngân sách nhà nước.
...
# Điều 32. Trách nhiệm của Bộ thống nhất thực hiện quản lý nhà nước về bảo vệ dữ liệu cá nhân

1. Giúp Chính phủ thực hiện quản lý nhà nước về bảo vệ dữ liệu cá nhân.
...
# 7. Thanh tra, kiểm tra, giải quyết khiếu nại, xử lý hành vi vi phạm quy định về bảo vệ dữ liệu cá nhân theo quy định của pháp luật

# Điều 33. Trách nhiệm của Bộ Thông tin và Truyền thông

1. Chỉ đạo các cơ quan truyền thông, báo chí, tổ chức và doanh nghiệp thuộc quản lý thực hiện bảo vệ dữ liệu cá nhân theo quy định tại Nghị định này.
2. Xây dựng, hướng dẫn và triển khai các biện pháp bảo vệ dữ liệu cá nhân, bảo đảm an toàn thông tin mạng đối với dữ liệu cá nhân trong các hoạt động truyền thông theo chức năng, nhiệm vụ được giao.
...
Quản lý, thanh tra, giám sát, xử lý vi phạm và áp dụng các quy định bảo vệ dữ liệu cá nhân đối với các cơ quan; tổ chức, cá nhân thuộc phạm vi quản lý của Bộ Quốc phòng theo quy định pháp luật và chức năng, nhiệm vụ được giao.
...
1. Thực hiện quản lý nhà nước đối với bảo vệ dữ liệu cá nhân đối với các ngành, lĩnh vực theo quy định của pháp luật về bảo vệ dữ liệu cá nhân.
...
# Điều 37. Trách nhiệm của Ủy ban nhân dân các tỉnh, thành trực thuộc trung ương
...
1. Triển khai các quy định về bảo vệ dữ liệu cá nhân tại Nghị định này.
2. Bố trí kinh phí phục vụ hoạt động bảo vệ dữ liệu cá nhân theo phân cấp quản lý ngân sách hiện hành.
3. Ban hành Danh mục dữ liệu mở phù hợp với quy định bảo vệ dữ liệu cá nhân.

# Điều 38. Trách nhiệm của Bên Kiểm soát dữ liệu cá nhân

1. Thực hiện các biện pháp tổ chức và kỹ thuật cùng các biện pháp an toàn; bảo mật phù hợp để chứng minh các hoạt động xử lý dữ liệu đã thực hiện theo quy định của pháp luật về bảo vệ dữ liệu cá nhân, rà soát và cập nhật các biện pháp này khi cần thiết.
...
2. Xử lý dữ liệu cá nhân theo hợp đồng hoặc thỏa thuận ký kết với Bên Kiểm soát dữ liệu cá nhân.
...
# 4. Bên Xử lý dữ liệu cá nhân chịu trách nhiệm trước chủ thể dữ liệu về các trình xử lý dữ liệu cá nhân gây ra.
...
2. Các doanh nghiệp siêu nhỏ, doanh nghiệp nhỏ, doanh nghiệp vừa, doanh nghiệp khởi nghiệp được quyền lựa chọn miễn trừ quy định về định cá nhân và bộ phận bảo vệ dữ liệu cá nhân trong thời gian 02 năm đầu kể từ khi thành lập doanh nghiệp.
...
Nơi nhận: Trung ương Đảng; TM. CHÍNH PHỦ

Ban Bí thư; Thủ tướng, các Phó Thủ tướng Chính phủ; Các bộ, cơ quan ngang bộ, cơ quan thuộc Chính phủ; HĐND, UBND các tỉnh, thành phố trực thuộc trung ương; Văn phòng Trung ương và các Ban của Đảng; Tổng Văn phòng Bí thư; Văn phòng Chủ tịch nước; Văn phòng Quốc hội; Viện kiểm sát nhân dân tối cao; Tòa án nhân dân tối cao; Kiểm toán nhà nước; Ủy ban Giám sát tài chính Quốc gia; Ngân hàng Chính sách xã hội; Ngân hàng Phát triển Việt Nam; Ủy ban trung ương Mặt trận Tổ quốc Việt Nam; Cơ quan trung ương của các đoàn thể; Cổng thông tin điện tử.

VPCP: BTCN, các PCN, các Vụ; Cục, đơn vị trực thuộc, báo; Lưu: VT, KSTT (2b) TM.
...
6NG
Phụ lục
(Kèm theo Nghị định số 13/2023/N-CP
...
Thông báo hồ sơ đánh giá tác động xử lý dữ liệu cá nhân gửi

# Mẫu số 05

Thông đổi nội dung thay hồ sơ báo
...
tên cá nhân yêu cầu cung cấp dữ liệu cá nhân:

1. Họ,
2. Người đại diện/Người giám hộ
3. Số CMTND/Thẻ căn cước                     dân/Hộ chiếu.
...
Theo quy định của Bộ luật Dân sự về người đại diện; người giám hộ dối với   yêu cầu cung cấp
người           nguời
tin là nguời chưa thành niên, người hạn chế năng lực hành vi dân sự,  mất năng lực hành vi dân sự,
thông
người có khó khăn trong nhận thức và làm chủ hành vi:

người đại diện/người giám hộ

Ghi nơi cư trú của              người đại diện/giám hộ.

Ghi số điện thoại, fax; email của thông tin liên quan cần cung cấp.

Ghi rõ tên chủ thể dữ liệu và các
...
# PHIẾU YÊU CẦU CUNG CÁP DỮ LIỆU CÁ NHÂN
...
3. Số CMTND/Thẻ căn cước/Hộ chiếu:
cấp ngày             tại
4. Địa chỉ sở của tổ chức, doanh nghiệp:
5. Số điện thoại:                    Fax:                                  E-mail:
6. Dữ liệu cá nhân yêu cầu cung cấp:
7. Mục đích yêu cầu cung cấp:
8. Yêu cầu cung cấp dữ liệu cá nhân lần thứ:
9. - a) Lần đầu
- b) Khác:              (ghi rõ số lần đã yêu cầu cung cấp thông tin)

Số lượng bản tin có nội dung nêu trên:
10. Phương thức nhận văn bản, hồ sơ, tài liệu:
11. - Nhận tại nơi yêu cầu cung cấp thông tin
- Nhận qua bưu điện (ghi rõ địa chỉ nhận):
- Fax (ghi rõ số fax):
- Nhận qua mạng điện tử (ghi rõ địa chỉ nhận):
- Hình thức khác (ghi rõ):
...
Đại diện của tổ chức, doanh nghiệp.

Theo quy định của Bộ luật Dân sự về đại diện yêu cầu cung cấp thông tin.

Ghi số điện thoại, fax; email của người đại diện ký, ghi rõ họ tên và đóng dấu của tổ chức, doanh nghiệp đó.
...
nghệ cao, Bộ (Cục An ninh mạng và phòng;                      công            an)

Thực hiện quy định về bảo vệ dữ liệu cá nhân,                    Công anh hồ sơ đánh giá tác động xử lý dữ liệu cá nhân; như sau:
...
| ----------------------------------------- | --- |
| Chức danh:                                | (cố |
| Số điện thoại liên lạc (định và di động): |     |
| Email:                                    |     |
...
(Cục An ninh mạng và phòng;                         nghệ cao, Bộ  an)

Thực hiện quy định về bảo vệ dữ liệu cá nhân;                     Công

anHồ sơ đánh giá tác động xử lý dữ liệu cá nhân, như sau:
...
Như trên;                            (Ký; ghi rõ họ tênđóng dâu)
...
Cục An ninh mạng và phòng;          tội phạm sử dụng -   nghệ

(Qua                                                             cao)

Thực hiện quy định về bảo vệ dữ liệu cá nhân;                    Công

an Hồ sơ đánh giá tác động xử lý dữ liệu cá nhân, như sau:
...
Quyết định thành lập/Giấy chứng nhận đăng ký doanh nghiệp/Giấy chứng nhận đầu tư số:         do    cấp
...
Tên hồ sơ: Hồ sơ đánh giá tác động xử lý dữ liệu cá nhân hoặc Hồ sơ đánh giá tác động
...
Nơi nhận: TM. TỔ CHỨC, DOANH NGHIỆP Như trên; dóng
...
(Cục An ninh mạng và phòng                        công
...
Hồ sơ đánh giá tác động chuyển dữ liệu cá nhân ra nước        gửi Bộ
...
Quyết định thành lậplGiấychứng nhậndăngký doanh nghiệplGiấy

ký kinh doanh/Giấy chứng nhận đầu tư số:
